package com.cookandroid.timetopay
    ...
    class Work : AppCompatActivity() {
        ...
        private val hourlyRate = 9620 // 초기 시급
        private val overtimeRate = 1.5 // 연장 근무 시급 배율
        private val nightShiftRate = 1.5 // 야간 근무 시급 배율
        private val simultaneousRate = 2.0 // 야간과 연장 근무 동시에 시급 배율
